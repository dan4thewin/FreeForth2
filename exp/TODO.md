...
- **fix-078**: Fix 078-ffpath — `"testfp.ff" needed` via FFPATH crashes with SIGILL. Needs GDB.
- **fix-073**: Fix 073-turnkey — REPL segfaults in turnkey binaries. Likely BSS/memory layout. Large.

## Port work
- exp 143+: CS0/getenv/ffpath verbatim port from i386
- exp 144+: openlib/needed verbatim port
